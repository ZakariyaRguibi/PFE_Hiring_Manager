...
export default class TfJobPositions extends NavigationMixin(LightningElement) {
    ...
    _enrichPosition(pos) {
        ...
        if (pos.Application_Deadline__c) {
            ...
            if (diffDays < 0) {
                ...
                deadlineLabel = deadline.toLocaleDateString('en-US', { month: 'short', day: 'numeric' });
            }
        }
        ...
        return {
            ...
            deadlineLabel,
            isOverdue,
            deadlineClass: isOverdue ? 'tf-card__deadline tf-card__deadline--overdue' : 'tf-card__deadline',
    ...
    get filteredPositions() {
        return this.positions.filter(pos => {
            const matchesFilter = this.activeFilter === 'All' || pos.Status__c === this.activeFilter;
            ...
            const matchesSearch = !term ||
                ...
                (pos.Required_Location__c && pos.Required_Location__c.toLowerCase().includes(term));
    ...
    get getFilterClassAll() { return this.getFilterClass('All'); }
    get getFilterClassOpen() { return this.getFilterClass('Open'); }
    get getFilterClassDraft() { return this.getFilterClass('Draft'); }
    get getFilterClassClosed() { return this.getFilterClass('Closed'); }
